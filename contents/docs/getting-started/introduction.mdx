...
### Description: 
This project is a sleek and minimalist YouTube client, developed using HTML, CSS, and JavaScript. It leverages the Invidious API to provide a seamless and privacy-focused video browsing experience.
